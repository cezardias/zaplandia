...
export default function DashboardLayout({
    ...
    const ZaplandiaLogo = ({ className = "w-8 h-8" }) => (
        <div 
            className={`${className} rounded-full border border-white/10 shadow-sm`} 
            style={{ 
    ...
    const menuItems = [
        ...
        { name: t[lang].menu.instagram, icon: <Instagram size={20} />, path: '/dashboard/instagram', roles: ['superadmin', 'admin', 'user'] },
