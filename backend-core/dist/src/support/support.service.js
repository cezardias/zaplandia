...
const support_article_entity_1 = require("./entities/support-article.entity");
    ...
    async findAll(query, category) {
        ...
        if (query) {
            return this.articleRepository.find({
                where: [
                    { title: (0, typeorm_2.ILike)(`%${query}%`), ...where },
                    { content: (0, typeorm_2.ILike)(`%${query}%`), ...where },
                    { category: (0, typeorm_2.ILike)(`%${query}%`), ...where },
                ],
...
exports.SupportService = SupportService = SupportService_1 = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(support_article_entity_1.SupportArticle)),
